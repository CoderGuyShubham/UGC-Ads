...
export const featuresData = [
  {
    ...
    title: "Smart Upload",
    desc: "Drag & drop your assets. We auto-complete formats and sizes.",
  },
  {
    icon: <ZapIcon className="w-6 h-6" />,
    title: "Instant Generation",
    desc: "Optimized models deliver in seconds with great fidelity.",
  },
  {
...
export const footerLinks = [
  ...
  },
  {
    ...
    links: [
      { name: "Twitter", url: "#" },
      { name: "LinkedIn", url: "https://www.linkedin.com/in/coderguyshubham" },
      { name: "GitHub", url: "https://github.com/CoderGuyShubham" },
    ],
  },
];
