          ...
          {!forCommunity && (
            ...
            >
              ...
              <div className="flex flex-col items-end w-32 text-sm">
                <ul
                  className={`text-xs ${menuOpen ? "block" : "hidden"} overflow-hidden right-0 peer-focus:block hover:block
                  w-40 bg-black/50 backdrop-blur-sm text-white border border-gray-500/50 rounded-lg shadow-md mt-2 py-1 z-10`}
                >
                  {gen.generatedImage && (
                    <a
                      href="#"
                  ...
                  {gen.generatedVideo && (
                    <a
                      ...
                      className="flex gap-2 items-center px-4 py-2 hover:bg-black/10 cursor-pointer"
                    >
                      <PlaySquareIcon size={14} /> Donwload Video
                    </a>
                  )}
